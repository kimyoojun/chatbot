...
train_df = pd.read_csv('data2/training.txt', sep='\t')
valid_df = pd.read_csv('data2/validing.txt', sep='\t')
test_df = pd.read_csv('data2/testing.txt', sep='\t')
...
def load_metrics(load_path):
    ...
    state_dict = torch.load(load_path, map_location=device)
    print(f'Model loaded from <== {load_path}')
    return state_dict['train_loss_list'], state_dict['valid_loss_list'], state_dict['global_steps_loss']
