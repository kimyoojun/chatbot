...
def rensnet50(pretrained=True, requires_grad=False):
...
class LRScheduler():
    def __init__(
        ...
        self.min_lr = min_lr
        self.factor = factor
        self.lr_scheduler = torch.optim.lr_scheduler.ReduceLR0nPlateau(
                self.optimizer,
                mode='min'
...
if args['lr_scheduler']:
    print('INF0: Initializing learning rate scheduler')
    lr_scheduler = LRScheduler(optimizer)
    loss_plot_name = 'lrs_loss'
    acc_plot_name = 'lrs_accuracy'
    model_name = 'lrs_model'
if args['early_stopping']:
    print('INF0: Initializing early stopping')
